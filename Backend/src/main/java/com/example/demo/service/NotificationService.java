...
public class NotificationService {
    ...
    @Transactional
    public void markAsRead(Long notificationId, Resident resident) {
        Notification notification = notificationRepository.findByIdAndResident(notificationId, resident)
    ...
    @Transactional
    public void deleteNotification(Long notificationId, Resident resident) {
        Notification notification = notificationRepository.findByIdAndResident(notificationId, resident)
                .orElseThrow(() -> new RuntimeException("Notification not found"));
