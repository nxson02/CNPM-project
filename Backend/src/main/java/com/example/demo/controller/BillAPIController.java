...
//    private BillRepository billRepository;
    ...
    private Map<String, Object> convertToDto(Bill bill) {
        ...
        dto.put("qrCodeUrl", bill.getQrCodeUrl());
        dto.put("paymentReferenceCode", bill.getPaymentReferenceCode());
        dto.put("transactionId", bill.getTransactionId());
        dto.put("lastCheckTime", bill.getLastCheckTime());
        dto.put("paymentError", bill.getPaymentError());
